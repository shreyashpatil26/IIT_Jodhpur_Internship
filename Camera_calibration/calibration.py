...
def calibrate(showPics=True):
    # Read Image
    root = os.getcwd()
    calibrationDir = root #os.path.join(root,'demoImages//calibration')
...
def removeDistortion(camMatrix,distCoeff): 
    root = os.getcwd()
    # imgPath="/home/shreyash/code/Camera_calibration/distorted_image/F_1_Color_copy.png"
    imgPath = os.path.join(root,'distorted_image/F_1_Color_copy.png')
